...
export const setTodolistTasksTC = (todolitsId: string) => (dispatch: Dispatch) => {
...
export const updateTaskStatusTC = (todolitsId: string, taskId: string, status: TaskStatuses) => (dispatch: Dispatch, getState: () => AppRootState) => {
